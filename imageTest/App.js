  ...
  const formatImage = async (image) => {
    ...
    const getPictures = () => {
            axios
                ...
                .then((response) => {
                    console.log(response.data)
                    const picture1 = response.data.picture1.data;
                    const picture2 = response.data.picture2.data;
                    const picture3 = response.data.picture3.data;
                    const picture4 = response.data.picture4.data;
